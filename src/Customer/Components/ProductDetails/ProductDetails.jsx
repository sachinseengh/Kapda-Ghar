  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">55 Rating</p>
                  <p className="ml-3 text-sm font-medium text-indigo-300">
                    388 Reviews
                  </p>
                </div>
              </div>
        ...
        {/* rating and reviews */}
        <section>
          <h1 className="font-semibold text-lg pb-14">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress
                        ...
                        value={55}
                        color="secondary"
                        sx={{ bgcolor: "#d0d8d0", borderRadius: 4, height: 7 }}
                      />
                    </Grid>
                  </Grid>
                  <Grid container alignItems="center" gap={2}>
